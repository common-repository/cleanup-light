...
<div class="border-bottom pb-15 mb-3 toptitle-sub"><?php esc_html_e('Listing Notifications', 'cleanup'); ?>
	</div>
...
<section class="content-main-right list-listings mb-30 mt-4">
		...
		<div class="row">
			<div class="col-md-12  "> <hr/>				
				<button type="button" onclick="cleanup_save_notification();"  class="btn green-haze"><?php  esc_html_e('Save',	'cleanup'); ?></button>
