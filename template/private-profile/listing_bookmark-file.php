...
?>
<div class="border-bottom pb-15 mb-3 toptitle-sub"><?php esc_html_e('Saved listings', 'cleanup'); ?>	
</div>	
											...
											<div class="col-md-10 listing-info px-0">
												<div class="text px-0 text-left">
													...
													?>
														...
														<?php
														$currentCategory = $main_class->cleanup_get_categories_caching($user_id,$cleanup_directory_url);
														$saved_icon='';
														$cat_name2='';
														$i=0;
													...
													<div class="group-button mt-2">	
														<?php
															...
															?>
															<button class="btn btn-small-ar" onclick="cleanup_listing_email_popup('<?php echo esc_html(trim($user_id));?>')" ><i class="far fa-envelope"></i></button>
															<?php
															}
														?>
														<button class="btn btn-small-ar" onclick="cleanup_listing_bookmark_delete_myaccount('<?php echo esc_html($user_id);?>','listingbookmark')"><i class="far fa-trash-alt"></i></button>
													</div>
												</div>
											</div>
										</div>
