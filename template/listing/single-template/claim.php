...
<?php
	...
	if($dir_addedit_claimtitle==""){$dir_addedit_claimtitle=esc_html__('Report','cleanup');}
	?>
		...
		<div class="row" >
			<div class="col-md-12">		
						...
						<div class="modal-header">
							...
							<button onclick="cleanup_contact_close();" type="button" class="close" data-dismiss="modal" aria-label="Close">
						...
						<div class="modal-body">
							<form action="#" id="message-claim" name="message-claim"    method="POST" >
								<div class="form-group row">
									<label class="col-md-4"  for="Name"><?php esc_html_e( 'Name', 'cleanup' ); ?></label>
									<input class="col-md-7 form-control"  id="subject" name ="subject" type="text">
								</div>
								<div class="form-group row">
									<label class="col-md-4"  for="eamil"><?php esc_html_e( 'Email', 'cleanup' ); ?></label>
									<input class="col-md-7 form-control"  name="email_address" id="email_address" type="email">
								</div>
								<div class="form-group row">
									<label class="col-md-4"  for="message"><?php esc_html_e( 'Message', 'cleanup' ); ?></label>
						...
						<div class="modal-footer">
							...
							<button onclick="cleanup_contact_close();" type="button" class="btn btn-small-ar" data-dismiss="modal"><?php esc_html_e( 'Close', 'cleanup' ); ?></button>
							<button type="button" onclick="send_message_claim();" class="btn btn-small-ar col-md-6 ml-2"><?php esc_html_e( 'Send Message', 'cleanup' ); ?></button>
						</div>
					</div>
