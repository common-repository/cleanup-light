...
<div class="listing-overview">
	<h5 class="border-bottom pb-15 mb-30 toptitle"><?php esc_html_e( 'Top Information', 'cleanup' ); ?></h5>
	<div class="row">
		<?php
			$saved_icon_cat='';
				...
				foreach($active_single_fields_saved  as $field_key => $field_value){
					...
					if( in_array($field_key,$data_for_top ) ){						
							...
							<div class="col-md-6 ">
								<div class="row mt-3"> 
									<div class="col-md-6  col-6">
										<i class="<?php echo esc_html($saved_icon); ?>"></i><span class="text-description"><?php esc_html_e( 'Industry', 'cleanup' ); ?></span>
									</div>
									<div class=" col-md-6  col-6">
						...
						<div class="col-md-6 ">
							<div class="row mt-3"> 
								<div class="col-md-6  col-6">
									<i class="<?php echo esc_html($saved_icon); ?>"></i><span class="text-description"><?php esc_html_e( 'Updated', 'cleanup' ); ?></span>
								</div>
								<div class=" col-md-6  col-6">
							...
							<div class="row mt-3"> 
								...
								<div class=" col-md-6  col-6">
									<?php if(get_post_meta($id,$field_key,true)!=''){?>
										<strong class="small-heading"><?php echo gmdate( 'd M-Y ', strtotime (get_post_meta($id,$field_key,true)) ); ?></strong>
										<?php
										}
										?>
								</div>
