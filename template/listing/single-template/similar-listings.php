...
<?php
	...
	if(!isset($single_page_icon_saved)){$single_page_icon_saved=get_option('cleanup_single_icon_saved' );}
...
<div class="sidebar-border">
	<div class="toptitle mb-3"><?php esc_html_e('Recent listing', 'cleanup'); ?></div>
	<?php
