...
<?php	
	$listingid=$id;
?>
<div class=" border-bottom pb-15 mb-3 toptitle"><i class="<?php echo esc_html($saved_icon); ?>"></i> <?php esc_html_e('Reviews for', 'cleanup'); ?> <?php echo get_the_title($listingid); ?></div>
	...
	<div class="row mx-0">
		<div class="col-md-6">
				...
				<?php
					...
					$author_reviews = $wpdb->get_results($wpdb->prepare("SELECT * FROM $wpdb->posts WHERE post_type =%s  and post_author=%s 	and post_status='publish' ORDER BY ID DESC",$post_type,$user_id));
				...
				?>
				<h3 class="toptitle m-0 py-2"><?php  esc_html_e('Average rating', 'cleanup'); ?></h3>
				<h3 class="toptitle bold padding-bottom-7"><?php echo number_format($avg_review, 1, '.', ''); ?> / <?php  esc_html_e('5', 'cleanup'); ?></h3>
				<?php
		...
		<div class="col-md-6">
			<h3 class="m-0 py-2 toptitle"><?php  esc_html_e('Rating breakdown', 'cleanup'); ?> </h3>
			
			<div class="d-flex review_rating_container">
				<div class="review_rating_star">
					<?php  esc_html_e('5', 'cleanup'); ?> <i class="fa fa-star 3x blue-star"></i>
				</div>
			...
			<div class="d-flex review_rating_container">
				<div class="review_rating_star">
					<?php  esc_html_e('4', 'cleanup'); ?> <i class="fa fa-star 3x blue-star"></i>
				</div>
				<div class="progress mt-2 review_rating_bar">
					<?php $bar_value=0;
						if($total_reviews>0){
            ...
            <div class="d-flex review_rating_container">
				<div class="review_rating_star ">
					<?php  esc_html_e('3', 'cleanup'); ?> <i class="fa fa-star 3x blue-star"></i>
				</div>
				<div class="progress mt-2 review_rating_bar">
					<?php $bar_value=0;
						if($total_reviews>0){
            ...
            <div class="d-flex review_rating_container">
				<div class="review_rating_star">
					<?php  esc_html_e('2', 'cleanup'); ?> <i class="fa fa-star 3x blue-star"></i>
				</div>
				<div class="progress mt-2 review_rating_bar">
					<?php $bar_value=0;
						if($total_reviews>0){
            ...
            <div class="d-flex review_rating_container">
				<div class="review_rating_star">
					<?php  esc_html_e('1', 'cleanup'); ?> <i class="fa fa-star 3x blue-star"></i>
				</div>
				<div class="progress mt-2 review_rating_bar">
					<?php $bar_value=0;
						if($total_reviews>0){
		...
		<div class="row my-5" >
			<div class="col-4 col-md-3">
				<?php
					...
					if($user_image_path==''){
						$user_image_path=cleanup_ep_URLPATH.'assets/images/Blank-Profile.jpg';
					}
				?>
				<?php
					...
					$profile_public=get_option('cleanup_profile_public_page');
				...
				<div class="text-description"><?php echo gmdate('M d, Y',strtotime($review->post_date)); ?></div>
			</div>
		...
		<div class="col-md-12">
            <form id="iv_review_form" name="iv_review_form" class="" role="form" onsubmit="return false;">
				<div class="row border-bottom">
					<div class="col-sm-12">
						<h3 class="mb-2 font-md "><?php  esc_html_e('Rate us and Write a Review', 'cleanup'); ?></h3>
					</div>
				</div>
				<div class="agent-info__separator my-1"></div>
				<div class="row form-group mt-5">
					<div class="col-12 col-md-3 text-description">
						<?php  esc_html_e('Subject', 'cleanup'); ?>
					</div>
					<div class="col-12 col-md-9">
						<input type="text" class="form-control review_sub" name="review_subject"   value="" placeholder="<?php  esc_html_e('Enter review title', 'cleanup'); ?>">
					</div>
				</div>
				<div class="row form-group my-0">
					<div class="col-md-3 text-description">
						<?php  esc_html_e('Rating', 'cleanup'); ?>
					</div>
					<div class="col-md-9">
						<div class="stars">
				...
				<div class="row form-group my-0">
					<div class="col-md-3 text-description">
						<?php  esc_html_e('Comments', 'cleanup'); ?>
					</div>
					<div class="col-md-9">
						<textarea class="form-control" cols="50"  name="review_comment" id="review_comment" placeholder="<?php  esc_html_e('Enter review comments', 'cleanup'); ?>" rows="4" ></textarea>
					</div>
				</div>
				<div class="row form-group mt-2">
					...
					<div class="col-md-4 text-right ">
						<button type="button" class="btn btn-small  my-2 py-2 " onclick="return cleanup_iv_submit_review();" ><?php  esc_html_e('Submit', 'cleanup'); ?></button>
