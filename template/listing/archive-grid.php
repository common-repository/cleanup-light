	...
	<section class=" py-5">
		<div class="container-fluid "  >
			...
			<div class="row" id="full_grid"> 
				...
				<div class="col-md-6 col-lg-6 col-xl-6 col-sm-12  archivescroll" id="dirpro_directories" >	
					...
					<div class="row mt-3 mb-2">	
						...
						<div class="col-xl-9 col-lg-9 col-md-9  col-sm-6 col-6 ">							
							<div class="listing-top-layout">
								...
								?>
								<ul class="mr-3">
									<li class="topicon-border hide-on-mobile"><a class="active lx-grid-one grid-one " href="#" data-placement="top" data-toggle="tooltip"  title="<?php  esc_html_e('Map Large','cleanup'); ?>"><i class="fa-solid fa-grip-vertical" aria-hidden="true"></i></a></li>
									<li class="topicon-border hide-on-mobile"><a class="lx-grid-two grid-two" href="#" data-placement="top" data-toggle="tooltip"  title="<?php  esc_html_e('Map Half','cleanup'); ?>" >
										<i class="fa-solid fa-grip" aria-hidden="true"></i>
									</a></li>
									<li class="topicon-border hide-on-mobile"><a class="lx-grid-three grid-three " href="#" data-placement="top" data-toggle="tooltip"  title="<?php  esc_html_e('Full Page','cleanup'); ?>"><i class="fas fa-expand-arrows-alt" aria-hidden="true"></i></a></li>
									<?php
										if( $cleanup_filter_badge>0 ){
										?>	
				...
				<div class=" col-md-6 col-lg-6 col-sm-12 " id="archivemap">
