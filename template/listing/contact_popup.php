		...
		<div class="row" >
			<div class="col-md-12">
				...
				<div class="modal-body">
					<?php
						include( cleanup_ep_template. 'listing/contact-form.php');						
					?>
				</div>
				<div class="modal-footer">					
					<button type="button" class="btn btn-small-ar col-md-6 " onclick="cleanup_contact_close();" ><?php  esc_html_e( 'Close', 'cleanup' ); ?></button>				
					<button type="button" class="btn btn-small-ar col-md-6 ml-2"  onclick="cleanup_contact_send_message_iv();" ><?php  esc_html_e( 'Send', 'cleanup' ); ?></button>							
				</div>					
			</div>				
		</div>	
	</div>	
