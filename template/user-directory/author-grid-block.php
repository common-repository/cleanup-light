	...
	<div class="card-grid-2 card-employers " >		
		<div class="text-center card-grid-2-image-rd  d-flex justify-content-around">
			<a href="<?php echo esc_url($page_link); ?>">
					...
					<?php
						$iv_profile_pic_url=get_user_meta($user->ID, 'cleanup_profile_pic_thum',true);
		...
		<div class="card-block-info">
			...
			<div class="card-2-bottom card-2-bottom-candidate mt-3">
				<div class="text-center"><?php				
					$total_listings= $main_class->cleanup_total_listing_count($user->ID, $allusers='no' );
					?>
						<a class="btn btn-border" href="<?php echo get_post_type_archive_link( $cleanup_directory_url ).'?&listing-author='.esc_attr($user->ID); ?>"><?php echo esc_html($total_listings);?> <?php esc_html_e('Open listings', 'cleanup'); ?></a>
					<div class="text-center">
					<a class="btn btn-border mt-2" href="<?php echo esc_url($page_link); ?>"><?php esc_html_e('View Profile', 'cleanup'); ?></a>
					</div>
