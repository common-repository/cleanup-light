...
<?php
	...
	wp_enqueue_style('cleanup_directory', cleanup_ep_URLPATH . 'admin/files/css/directory.css');
	...
	$args['meta_query'] = array(
		$user_name_search,$city_search, $categories_search,
	);
	...
	<div class="container-fluid " >
		<div class="row " >
			<div class="col-md-4 col-lg-4 col-xl-4 col-sm-12  " >						
				<?php
					include( cleanup_ep_template. 'user-directory/author-search.php');
				?>
			</div>
			<div class="col-md-8 col-lg-8 col-xl-8 col-sm-12  " id="user_directory" >	
					...
					<?php	
						...
						if ( ! empty( $user_query->results ) ) {
							foreach ( $user_query->results as $user ) {
								...
								include( cleanup_ep_template. 'user-directory/author-grid-block.php');
								$i++;
							}
						}	
							?>
				...
				<div class="col-12">
					<?php
						...
						'mid_size'     => 1,
						'prev_next'    => true,
						'prev_text'    => esc_html__( '« Prev','cleanup' ),
						'next_text'    => esc_html__( 'Next »','cleanup' ),
						'add_args'     => $args,
						'add_fragment' => ''
						], $params )
						);			 				
...
<?php
	wp_enqueue_script('cleanup_user-directory', cleanup_ep_URLPATH . 'admin/files/js/user-directory.js');
