		...
		<div class="sidebar-filters">
			<div class="filter-block mb-30">			
				<div class="form-group">
					<input type="text" name="user_name_search" value="<?php echo (isset($_REQUEST['user_name_search'])?$_REQUEST['user_name_search']:''); ?>" class="form-control " placeholder="<?php esc_html_e('Search','cleanup'); ?>">				
				</div>
			</div>
			<div class="filter-block mb-30">
				<h5 class="medium-heading mb-3"><?php esc_html_e('Categoy','cleanup'); ?></h5>
			...
			<div class="filter-block mb-30">
				<h5 class="medium-heading mb-10"><?php esc_html_e('Location','cleanup'); ?></h5>
				<div class="form-group no-gutters">
					<?php
						$argscat = array(
						'type'                     => $cleanup_directory_url,
			...
			<div class="buttons-filter">			
				...
				<button type="submit"  class="btn btn-big mt-2"><?php esc_html_e('Apply filter','cleanup'); ?></button>
			</div>
		</div>
	</div>
</form>