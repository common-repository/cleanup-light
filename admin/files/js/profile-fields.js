...
function cleanup_add_listingfield(){	
	"use strict";
		...
		wpdatatable.row.add( [
			...
			'<div class="col-md-12 mt-2 "> <button type="button" class="btn btn-primary btn-sm"  onclick="return cleanup_remove_listingfield('+profile_data.pi+');"  ><span  class="dashicons dashicons-trash ml-1"></span></button></div></div>', catall		
...
function cleanup_remove_listingfield(div_id){
	"use strict";
...
function cleanup_add_profile_field(){
	"use strict";
...
function cleanup_update_profile_signup_fields(){
	"use strict";
	var search_params = {
		"action": 		"cleanup_update_profile_signup_fields",
