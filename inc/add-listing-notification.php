<?php
	...
	$contact_email_subject =  esc_html__( 'New listing added', 'cleanup' ); 
	$message =  esc_html__( 'New listing added to your site. You can publish or delete from your site dashboard', 'cleanup' ); 
