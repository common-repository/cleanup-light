...
<?php
  ...
  text-align:center;
	...
	';
	update_option('cleanup_signup_email', trim($client_signup_email_template)  ); 
	$signup_subject = 'Welcome To '.get_bloginfo();
	update_option('cleanup_signup_email_subject', $signup_subject  ); 
  ...
  text-align:center;
	...
	';
	update_option('cleanup_forget_email', trim($client_forget_email_template)  ); 
	$forget_subject = 'Forget Password '.get_bloginfo();
	update_option('cleanup_forget_email_subject', $forget_subject  ); 
  ...
  text-align:center;
	...
	';
	update_option('cleanup_contact_email', trim($contact_email_template)  ); 
	$contact_subject = 'New Message '.get_bloginfo();
	update_option('cleanup_contact_email_subject', $contact_subject  ); 
// listing Apply email
  ...
  text-align:center;
	...
	';
	update_option('cleanup_apply_email', trim($apply_email_template)  ); 
	$contact_subject = 'Application For';
	update_option('cleanup_apply_email_subject', $contact_subject  ); 
...
<!DOCTYPE html>
  ...
  border-radius:6px !important;">
	...
	-moz-box-shadow: inset 0px 1px 0px 0px rgba(255,255,255,.5);
	box-shadow: inset 0px 1px 0px 0px rgba(255,255,255,.5);">
	<a  style="color: #FFFFFF; text-decoration:none;" href="'.site_url().'" target="_blank">New listing for you</a></h1></td>
	</tr>
	</table>
	<!-- End Header --></td>
	</tr>
  ...
  border-radius:6px !important;
	...
	<td valign="top"><div style="color: #555;font-family:Arial;font-size:14px;line-height:150%;text-align:left;">
   <p> Dear [user_name],<br><br/>
	<p>	We have new listing that match your alert: </p>

	<table cellspacing="0" cellpadding="6" style="width: 100%; border-radius:5px; overflow:hidden;border-top:1px solid #aaa" >                              
	
	<tr>
	<td style="text-align:left; vertical-align:middle; word-wrap:break-word;width:25%">listing Name : <br>
	</td>
	<td style="text-align:left; vertical-align:middle; "> [iv_member_listing_name]</td>
	</tr>
	<tr>
		<td style="text-align:left; vertical-align:middle; word-wrap:break-word; width:25%">URL : <br>
	</td>
	<td style="text-align:left; vertical-align:middle; ">[iv_member_listing_url]</td>    
	</tr>
	<tr>
		<td style="text-align:left; vertical-align:middle; word-wrap:break-word; width:25%">Deadline : <br>
	</td>
	<td style="text-align:left; vertical-align:middle; ">[iv_member_listing_deadline]</td>    
	</tr>
  ...
  text-align:center;
	...
	';
	update_option('cleanup_notification_email', trim($notification_email_template)  ); 
	$contact_subject = 'listing Notification';
	update_option('cleanup_notification_email_subject', $contact_subject  ); 
